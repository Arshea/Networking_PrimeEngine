		...
		// start root.PE
		{
			...
			// start root.PE.Components
			{
				PE::Components::Component::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					...
					PE::Components::SceneNode::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
						...
						PE::Components::SceneManager::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					...
					PE::Components::SkyVolume::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
			...
			// start root.PE.Events
			{
				PE::Events::Event::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					...
					//Assignment 4
					PE::Events::Event_PHYSICS_PRE_UPDATE::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					...
					//PE::Events::Event_MOVE_PLAYER::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);

					PE::Events::Event_SERVER_CLIENT_CONNECTION_ACK::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					PE::Events::Event_CLIENT_SERVER_UDP_ACK::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					PE::Events::Event_SERVER_CLIENT_UDP_ACK::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
			}
			// end root.PE.Events
			pLuaEnv->EndRegistrationTable();
		}
