...
struct ClientNetworkManager : public NetworkManager
{
	...
	PE_DECLARE_IMPLEMENT_EVENT_HANDLER_WRAPPER(do_SERVER_CLIENT_UDP_ACK);
	void do_SERVER_CLIENT_UDP_ACK(PE::Events::Event *pEvt);
	...
	static int l_clientConnectToUDPServer(lua_State *luaVM);
	//
	//////////////////////////////////////////////////////////////////////////
