...
void ClientConnectionManager::initializeConnected(t_socket sock, sockaddr_in recvaddr, sockaddr_in sendaddr)
{
	ConnectionManager::initializeConnected(sock, recvaddr, sendaddr);
}
