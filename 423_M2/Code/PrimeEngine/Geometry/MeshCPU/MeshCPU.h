...
namespace PE {
	...
	struct MeshCPU : PE::PEAllocatableAndDefragmentable
	{
		...
		void createBillboardMeshWithColorTextureCubeMap(const char *textureFilename, const char *package, PrimitiveTypes::Float32 w = 1000.0f, PrimitiveTypes::Float32 h = 1000.0f, ESamplerState customSamplerState = SamplerState_Count);
