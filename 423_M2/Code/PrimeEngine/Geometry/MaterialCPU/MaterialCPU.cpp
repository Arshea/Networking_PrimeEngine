...
namespace PE {
	...
	void MaterialCPU::createMaterialWithColorTextureCubeMap(const char *textureFilename, const char *package, ESamplerState customSamplerState /* = SamplerState_Count*/)
	{
		m_diffuse = Vector4(0.5f, 0.5f, 0.5f, 1.0f);
