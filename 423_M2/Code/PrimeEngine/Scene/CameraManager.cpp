...
namespace PE {
	namespace Components {
		...
		CameraManager::CameraManager(PE::GameContext &context, PE::MemoryArena arena, Handle hMyself) : Component(context, arena, hMyself)
		{
			...
			pCamSN->m_base.setPos(Vector3(-5.0f, 4.0f, -7.0f)); // Artem what the fuck
			pCamSN->m_base.turnInDirection(Vector3(0.0f, 1.0f, -1.1f) - Vector3(-5.0f, 4.0f, -7.0f)); // Whenever I think I'm bad at code I read Artem's stuff and realise there's still hope
		}
