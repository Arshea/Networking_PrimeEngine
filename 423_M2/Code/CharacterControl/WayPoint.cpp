...
int Event_CREATE_WAYPOINT::l_Construct(lua_State* luaVM)
{
	...
	const char* nextWayPointName[3];
	nextWayPointName[0] = lua_tostring(luaVM, -numArgs--);
	nextWayPointName[1] = lua_tostring(luaVM, -numArgs--);
	nextWayPointName[2] = lua_tostring(luaVM, -numArgs--);
	...
	StringOps::writeToString(nextWayPointName[0], pEvt->m_nextWayPointName[0], 32);
	StringOps::writeToString(nextWayPointName[1], pEvt->m_nextWayPointName[1], 32);
	StringOps::writeToString(nextWayPointName[2], pEvt->m_nextWayPointName[2], 32);
